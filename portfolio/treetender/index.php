...
?>
    ...
    <div class="span">
      <div class="loop-12">
        <h1 class="page-title">TreeTender</h1>
        <h3 id="desc" class="heading-three">Re-Designing Network Marketing</h3>
      </div>
    </div>
        ...
        <div class="span">
          ...
          <div class='loop-12'>
            <div class='wide-image'>
             ...
             <p>Network marketing has a bad reputation for a lack of communication and encouragement among team members. Our job here was to design a product that would help solve this problem. The plan was to design an environment that would keep team members not only in touch with one and other, but also in the loop with what work others are doing.</p>

             <div class="break"></div>

             <h2 class="heading-two">Identifying the problems</h2>
            ...
            <div class="wide-image">
             ...
             <h2 class="heading-two">User Experience</h2>
             ...
             <h2 class="heading-two">Style Guide</h2>
            ...
            <p>One of the biggest challenges of the project was carefully crafting the high amounts of data users are presented with. By delaying animations in order of importance we could consciously show users where the eye needs to go first. Here's one test, which would hopefully draw users in.</p>
                  ...
                  <svg width="315px" height="107px" viewBox="0 0 315 107" version="1.1">
                    <defs>
                        <linearGradient x1="0%" y1="100%" x2="100%" y2="100%" id="linearGradient-1">
                            <stop stop-color="#58AC2C" offset="0%"></stop>
                            <stop stop-color="#58AC2C" offset="41.7610013%"></stop>
                            <stop stop-color="#58AC2C" offset="78.6870217%"></stop>
                            <stop stop-color="#58AC2C" offset="100%"></stop>
                        </linearGradient>
                    </defs>
                    <g id="Page-1" stroke="none" stroke-width="2" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                        <path d="M2.10546875,95.75 L40.5546875,68.3476562 L55.2109375,81.1796875 L65.2148437,76.3945312 L96.1835937,86.8320312 L131.023438,19.9414062 L142.15625,23.7226562 L183.605469,2.1953125 L211.007812,22.3320312 L234.320312,71.5664062 L234.667969,83.0039062 L244.019531,83.0039062 L247.105469,88.8320312 L312.695312,104.839844" id="Path-1" stroke="url(#linearGradient-1)" stroke-width="2" sketch:type="MSShapeGroup" class="path"></path>
                    </g>
                </svg>
              </div>

             <h2 class="heading-two">The Design Proccess</h2>
            ...
            <h2 class="heading-two">Final Screens</h2>
